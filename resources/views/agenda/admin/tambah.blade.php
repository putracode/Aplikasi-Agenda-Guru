...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" action="/tambahagendaadmin" method="POST" enctype="multipart/form-data"">
                @csrf
                @csrf
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <input type="number" class="form-control @error('jumlah_hadir') is-invalid @enderror"
                        id="exampleInputEmail3" name="jumlah_hadir" placeholder="Hadir">
                    @error('jumlah_hadir')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="col-md-6">
                    <input type="number" class="form-control @error('jumlah_tidak_hadir') is-invalid @enderror"
                        id="exampleInputEmail3" name="jumlah_tidak_hadir" placeholder="Tidak Hadir">
        ...
        <div class="mb-4">
            ...
            <input type="text" class="form-control @error('link') is-invalid @enderror" id="exampleInputEmail8"
                name="link">
            @error('link')
            <div class="invalid-feedback">
                {{ $message }}
        ...
        <a href="/agendaadmin" class="btn btn-danger px-5 mr-2 float-right">Cancel</a>
        </form>
    </div>
</div>
</div>
